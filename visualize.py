...
if __name__ == "__main__":
    json_files = ['./save_loss_path/784_128_128_10_relu.json', './save_loss_path/784_128_64_10_relu.json', './save_loss_path/784_128_32_10_relu.json', './save_loss_path/784_128_16_10_relu.json']
    labels = ['Model 1', 'Model 2', 'Model 3', "Model 4"]
    plot_training_history(json_files, labels)

    model_path = "./save_model_path/784_128_128_10_relu/"
    plot_network_para(model_path)
